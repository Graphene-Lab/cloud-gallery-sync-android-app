...
class PhotoSyncWorkerTest {
    ...
    inner class WorkerExecutionTests {
        ...
        fun doWork_withNewPhotos_syncsInBatchesAndReturnsSuccess() = runTest {
            ...
            doAnswer { invocation ->
                val progressCallback = invocation.getArgument<(com.graphenelab.communication.crypto.FileUploader.ChunkProgress) -> Unit>(3)
                // Simulate completion
                progressCallback.invoke(
                    com.graphenelab.communication.crypto.FileUploader.ChunkProgress(
                        "test.jpg",
                        1,
                        1,
                        true
